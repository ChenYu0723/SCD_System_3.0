...
def load_data(filter_hour=None):
    ...
    # od_path = "data/corr_matrix/inFlow_corr_matrix.csv"
    # od_path = "data/corr_matrix/inFlow_corr_matrix_nor.csv"
...
def preprocess_data(data, train_rate, seq_len, pre_len):
...
if __name__ == '__main__':
    ...
    X_train_in, Y_train_in, X_test_in, Y_test_in = preprocess_data(inFlow_data, TRAIN_RATE, SEQ_LEN, PRE_LEN)
    X_train_out, Y_train_out, X_test_out, Y_test_out = preprocess_data(outFlow_data, TRAIN_RATE, SEQ_LEN, PRE_LEN)
    # print(X_train)
